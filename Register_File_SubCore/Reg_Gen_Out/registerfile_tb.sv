...
//
//---------- module RV32I_regfile_test_leaf_bfm
//
module RV32I_regfile_test_leaf_bfm
(
  address,
...
module RV32I_regfile_test ( );
  ...
  wire   [31:0] l2h_X0_x0_zero_r;
  wire   [31:0] l2h_XRA_xra_r;
  wire   [31:0] l2h_XSP_xsp_r;
  wire  active;
  wire  done;
  ...
  RV32I_regfile_pio pio_dut_0 (
    .clk(clk),
    .reset(reset),
    .h2l_XSP_xsp_w(h2l_XSP_xsp_w),
    ...
    .l2h_X0_x0_zero_r(l2h_X0_x0_zero_r),
    .l2h_XRA_xra_r(l2h_XRA_xra_r),
    .l2h_XSP_xsp_r(l2h_XSP_xsp_r),
  ...
  RV32I_regfile_test_leaf_bfm leaf_bfm (
    .address(address),
    .wr_data(wr_data),
    .wr_enable(wr_enable),
